...
```
cd existing_repo
git remote add origin https://gitlab.com/christopher.ntakpe/intranet-v2v.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/christopher.ntakpe/intranet-v2v/-/settings/integrations)
...
>>>>>>> 7ad072aab0007756bd3be156cde87d06dc38a42c
